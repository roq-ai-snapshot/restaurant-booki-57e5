  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine, where customers reserve tables and staff efficiently manage reservations and menus. Simplifying restaurant management one reservation at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine, where customers reserve tables and staff efficiently manage reservations and menus. Simplifying restaurant management one reservation at a time.`}
            </Text>
            <Box
